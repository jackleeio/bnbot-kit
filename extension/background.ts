...
const scraperHandlers: Record<string, (msg: any) => Promise<any>> = {
  ...
  scrape_ctrip_hotel_search: (m) => getCtripHotelSearch(m.city, m.checkin, m.checkout, m.limit),
  scrape_ctrip_flight: (m) => getCtripFlight(m.from, m.to, m.date, m.limit),
