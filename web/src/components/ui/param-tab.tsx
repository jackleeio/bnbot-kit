...
export default function ParamTab({
  ...
  return (
    ...
    >
      <Tab.List
        className={cn(
          'relative mb-6 bg-body text-sm uppercase before:absolute before:bottom-0 before:left-0 before:w-full before:rounded-sm before:bg-gray-100 dark:bg-dark dark:before:bg-gray-800 sm:gap-8 sm:rounded-none md:before:h-px',
          tabListClassName,
        )}
      >
