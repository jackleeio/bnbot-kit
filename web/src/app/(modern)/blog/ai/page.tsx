...
export const metadata = {
  title: 'AI Articles | BNBot Blog',
  description: 'AI-focused articles, execution playbooks, and daily signals from BNBot.',
};

export default function BlogAiPage() {
  const posts = getBlogPostsByTag('ai');

  return (
    <section className="relative overflow-hidden bg-white">
      <div className="relative mx-auto max-w-5xl px-4 py-10 sm:px-6 lg:px-8 lg:py-12">
        <h1 className="text-4xl font-black tracking-tight text-slate-950 sm:text-5xl">AI Articles</h1>
        <p className="mt-4 text-base leading-7 text-slate-600 sm:text-lg">
          Daily AI execution notes, model updates, and product growth insights.
        </p>
