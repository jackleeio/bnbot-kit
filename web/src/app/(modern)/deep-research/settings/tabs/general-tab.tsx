...
import {
  ...
  FormLabel,
  FormMessage,
} from "~/components/deep-research/ui/form";
import { Input } from "~/components/deep-research/ui/input";
import { Label } from "~/components/deep-research/ui/label";
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>By default, each research plan has 5 steps.</FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            />
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    By default, each search step has 5 results.
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
