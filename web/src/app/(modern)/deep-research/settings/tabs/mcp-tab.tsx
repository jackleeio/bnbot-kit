...
import { Switch } from "~/components/deep-research/ui/switch";
    ...
    <div className="flex flex-col gap-4">
      <header>
        ...
        <div className="text-muted-foreground markdown text-sm">
          The Model Context Protocol boosts BNBOT by integrating external tools for tasks like private domain searches, web browsing, food ordering, and more. Click here to learn more about MCP.
        </div>
      </header>
      <main className="min-h-[300px]">
        <ul id="mcp-servers-list" className="flex flex-col gap-4">
          {servers.length === 0 && (
            <li className="flex flex-col items-center justify-center py-12 text-muted-foreground">
            ...
            return (
              ...
              >
                <div className="absolute top-3 right-2">
                  <Tooltip title="Toggle server enabled/disabled">
