...
import { Badge } from "~/components/deep-research/ui/badge";
...
import { Tabs, TabsContent } from "~/components/deep-research/ui/tabs";
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[850px]">
        <DialogHeader>
          <DialogTitle>BNBOT Settings</DialogTitle>
          <DialogDescription>
            Manage your BNBOT settings here.
          </DialogDescription>
        </DialogHeader>
        <Tabs value={activeTabId}>
          <div className="flex h-120 min-h-[480px] w-full overflow-auto border-y">
