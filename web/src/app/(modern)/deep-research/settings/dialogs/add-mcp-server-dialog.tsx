...
import { Textarea } from "~/components/deep-research/ui/textarea";
...
export function AddMCPServerDialog({
  ...
  const handleChange = useCallback((value: string) => {
    ...
    if (keys.length === 0) {
      setValidationError("Missing server name");
      return;
    }
  }, []);
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[560px]">
        ...
        <DialogDescription>
          Configure MCP servers by providing a JSON configuration.
          <br />
          Please ensure the JSON format is valid and includes all required fields.
        </DialogDescription>
