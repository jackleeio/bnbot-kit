...
import { LanguageSwitcher } from "~/components/deep-research/deer-flow/language-switcher";
import { NumberTicker } from "~/components/deep-research/magicui/number-ticker";
