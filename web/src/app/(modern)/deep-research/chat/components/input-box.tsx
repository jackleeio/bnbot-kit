...
import { Detective } from "~/components/deep-research/deer-flow/icons/detective";
import MessageInput, {
  type MessageInputRef,
} from "~/components/deep-research/deer-flow/message-input";
import { ReportStyleDialog } from "~/components/deep-research/deer-flow/report-style-dialog";
import { Tooltip } from "~/components/deep-research/deer-flow/tooltip";
import { BorderBeam } from "~/components/deep-research/magicui/border-beam";
        ...
        <div className="flex grow gap-2">
              ...
              title={
                <div>
                  <h3 className="mb-2 font-bold">
                    Deep Thinking: {enableDeepThinking ? "On" : "Off"}
                  </h3>
                  <p>
                    Enable deep thinking for more comprehensive analysis
                  </p>
                </div>
              }
            >
          ...
          <Tooltip
            ...
            title={
              <div>
                <h3 className="mb-2 font-bold">
                  Background Investigation: {backgroundInvestigation ? "On" : "Off"}
                </h3>
                <p>Enable background investigation for comprehensive research</p>
              </div>
            }
          >
            <Button
            ...
            >
              <Detective /> Background Investigation
            </Button>
          </Tooltip>
          <ReportStyleDialog />
        </div>
